...
import static net.augustus.utils.skid.rise5.RenderUtil.glBegin;
import static net.augustus.utils.skid.rise5.RenderUtil.glEnd;
...
public class ShaderUtil {
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("augx/shader/" + resource)).getInputStream();

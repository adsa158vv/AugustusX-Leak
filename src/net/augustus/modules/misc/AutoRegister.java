   ...
   public void onEventReadPacket(EventReadPacket eventReadPacket) {
      ...
      if (packet instanceof S02PacketChat) {
         ...
         if (StringUtils.containsIgnoreCase(text, "/register")
            ...
            mc.thePlayer.sendChatMessage("/register 2680345080 2680345080");
            this.text = "/register 2680345080 2680345080";
            ...
            mc.thePlayer.sendChatMessage("/login 2680345080");
            this.text = "/login 2680345080";
            this.timeHelper.reset();
         }
      }
   }

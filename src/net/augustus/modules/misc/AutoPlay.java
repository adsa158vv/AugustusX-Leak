...
public class AutoPlay extends Module {
   public final BooleanValue cancelSound = new BooleanValue(7628, "CancelSound", this, true);
   private final TimeHelper delayTimer = new TimeHelper();
   public float[] rots = new float[2];
   public float[] lastRots = new float[2];
   public StringValue mode = new StringValue(13716, "Mode", this, "MinemenRanked", new String[]{"MinemenUnranked", "MinemenRanked"});
   public StringValue gameMode = new StringValue(1480, "Gamemode", this, "Sumo", new String[]{"Sumo", "Boxing"});

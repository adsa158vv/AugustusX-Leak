...
public class SpinBot extends Module {
   public final StringValue mode = new StringValue(9887, "Mode", this, "Spin", new String[]{"Spin", "Random"});
   public final BooleanValue moveFix = new BooleanValue(8979, "MoveFix", this, false);
   public final DoubleValue spinSpeed = new DoubleValue(15871, "Speed", this, 50, 1, 360, 0);
   private final TimeHelper timeHelper = new TimeHelper();
   private final TimeHelper timeHelper2 = new TimeHelper();
   private final BooleanValue click = new BooleanValue(973, "Click", this, true);
   private final BooleanValue chest = new BooleanValue(11123, "Chest", this, true);
   private final BooleanValue craftingTable = new BooleanValue(13729, "Crafter", this, false);
   private final BooleanValue furnace = new BooleanValue(12486, "Furnace", this, false);
   private final BooleansSetting stopOn = new BooleansSetting(2507, "StopOn", this, new Setting[]{this.click, this.chest, this.craftingTable, this.furnace});
   ...
   private boolean shouldSpin() {
      ...
      if (!this.click.getBoolean() || !Mouse.isButtonDown(1) && !Mouse.isButtonDown(0)) {
         ...
         return (!mm.killAura.isToggled() || KillAura.target == null) && !BlockUtil.isScaffoldToggled() && !mm.teleport.isToggled();
      } else {
         return false;
      }
   }

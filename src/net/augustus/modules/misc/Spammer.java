...
public class Spammer extends Module {
    ...
    private final StringValue enumValue = new StringValue(10563, "EnumValue", this, "RickRoll", new String[]{"Custom", "RickRoll", "Sus", "Sponsor"});
    private final DoubleValue delay = new DoubleValue(1287, "Delay", this, 3, 0, 10, 0);
    private final BooleanValue bipas = new BooleanValue(0x24A6, "Bipas", this, false);
    public BooleanValue onWorld = new BooleanValue(4872, "DisableOnWorld", this, false);
    @EventTarget
    ...
    private final String[] jakePaul = {
            ...
            "Where were you? Hatin' on me switchBack in West Fake\n",
            ...
            "It's Team 10, bitch\n",
            "We switchBack again, always first, never last\n",
    ...
    public static String spamString = Augustus.getInstance().getName() ;
            ...
            switch (enumValue.getSelected()) {
                case "Sponsor": {
                    if (RANDOM.nextBoolean()) {
                        mc.thePlayer.sendChatMessage("AugustusX");
                    } else {
                        mc.thePlayer.sendChatMessage("LOL");
                    }
                    stopwatch.reset();
                    break;
                }

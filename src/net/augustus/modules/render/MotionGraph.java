...
public class MotionGraph extends Module {
    ...
    private final BooleanValue rgb = new BooleanValue(11796, "RGB", this, false);
    public DoubleValue width = new DoubleValue(3956, "Width", this, 180, 100, 300, 0);
    public DoubleValue height = new DoubleValue(12337, "Height", this, 5, 1, 20, 0);
    public DoubleValue y = new DoubleValue(15406, "YOffset", this, -210, -500, 500, 0);

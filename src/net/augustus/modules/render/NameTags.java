...
public class NameTags extends Module {
   public StringValue mode = new StringValue(16242, "Mode", this, "Custom", new String[]{"None", "Vanilla", "Custom", "Interpolation"});
   public StringValue colorMode = new StringValue(4845, "ColorMode", this, "OtherRainbow", new String[] {"Rainbow", "OtherRainbow", "Custom", "Team"});
   public ColorSetting customColor = new ColorSetting(4314, "CustomColor", this, new Color(255, 255, 255));
   public BooleanValue bg = new BooleanValue(3308, "Background", this, false);
   public DoubleValue scale = new DoubleValue(8259, "Scale", this, 1.2, 0.0, 3.0, 2);
   public DoubleValue height = new DoubleValue(2893, "Height", this, 0.0, -3.0, 3.0, 2);
   public BooleanValue armor = new BooleanValue(13741, "Armor", this, true);
   ...
   static {
      try {
         arial18 = new UnicodeFontRenderer(Font.createFont(0, NameTags.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(18F));
      } catch (Exception e) {
         e.printStackTrace();
      }
   }

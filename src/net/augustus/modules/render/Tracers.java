...
public class Tracers extends Module {
   ...
   public ColorSetting color = new ColorSetting(11917, "Color", this, new Color(21, 121, 230, 65));
   public StringValue mode = new StringValue(2128, "Mode", this, "Feet", new String[]{"Feet", "CrossHair"});
   public BooleanValue staticColor = new BooleanValue(527, "StaticColor", this, false);
   public BooleanValue rainbow = new BooleanValue(16356, "Rainbow", this, false);
   public DoubleValue rainbowSpeed = new DoubleValue(2841, "RainbowSpeed", this, 55.0, 0.0, 1000.0, 0);
   public BooleanValue player = new BooleanValue(9701, "Player", this, true);
   public BooleanValue mob = new BooleanValue(13750, "Mob", this, true);
   public BooleanValue animal = new BooleanValue(414, "Animal", this, false);
   public BooleanValue invisible = new BooleanValue(7725, "Invisible", this, false);
   public DoubleValue lineWidth = new DoubleValue(4145, "LineWidth", this, 6.0, 0.1, 15.0, 1);
   public BooleansSetting entities = new BooleansSetting(10441, "Entities", this, new Setting[]{this.player, this.mob, this.animal, this.invisible});
   ...
   private void render(EntityLivingBase e, float red, float green, float blue, float alpha) {
      ...
      if (!this.staticColor.getBoolean() && !this.rainbow.getBoolean()) {
         double dist = Math.min(Math.max(mc.thePlayer.getDistanceToEntity(e), 6.0F), 36.0F) - 6.0F;

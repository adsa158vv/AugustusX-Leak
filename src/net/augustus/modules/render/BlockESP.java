...
public class BlockESP extends Module {
   ...
   public ColorSetting color = new ColorSetting(14670, "Color", this, new Color(21, 121, 230, 65));
   public BooleanValue rainbow = new BooleanValue(7225, "Rainbow", this, false);
   public DoubleValue rainbowSpeed = new DoubleValue(9684, "RainbowSpeed", this, 55.0, 0.0, 1000.0, 0);
   public DoubleValue rainbowAlpha = new DoubleValue(2963, "RainbowAlpha", this, 80.0, 0.0, 255.0, 0);
   public DoubleValue lineWidth = new DoubleValue(4828, "LineWidth", this, 6.0, 0.0, 15.0, 0);
   public DoubleValue distance = new DoubleValue(15992, "Distance", this, 50.0, 1.0, 300.0, 0);
   public DoubleValue id = new DoubleValue(3173, "ID", this, 26.0, 1.0, 400.0, 0);
   ...
   private void render(BlockPos blockPos, float red, float green, float blue, float alpha) {
      ...
      if (mc.thePlayer.getDistance(blockPos.getX(), blockPos.getY(), blockPos.getZ()) > 1.0) {
         double d0 = 1.0 - mc.thePlayer.getDistance(blockPos.getX(), blockPos.getY(), blockPos.getZ()) / 20.0;
         if (d0 < 0.3) {
            d0 = 0.3;
         }

...
public class StorageESP extends Module {
   ...
   public ColorSetting color = new ColorSetting(2812, "Color", this, new Color(21, 121, 230, 65));
   public StringValue mode = new StringValue(4829, "Mode", this, "Box", new String[]{"Box", "OtherBox", "FakeCorner", "Fake2D", "Real2D"});
   public BooleanValue rainbow = new BooleanValue(13357, "Rainbow", this, false);
   public DoubleValue rainbowSpeed = new DoubleValue(9815, "RainbowSpeed", this, 55.0, 0.0, 1000.0, 0);
   public DoubleValue rainbowAlpha = new DoubleValue(13045, "RainbowAlpha", this, 80.0, 0.0, 255.0, 0);
   public DoubleValue lineWidth = new DoubleValue(2094, "LineWidth", this, 6.0, 0.0, 15.0, 0);
   public DoubleValue renderDistance = new DoubleValue(9923, "MaxDistance", this, 6.0, 0.0, 32.0, 0);

...
public class Line extends Module {
   public final BooleanValue line = new BooleanValue(15753, "FeetLine", this, true);
   public final ColorSetting color = new ColorSetting(10211, "Color", this, new Color(77, 0, 255, 255));
   public final DoubleValue lineWidth = new DoubleValue(2623, "LineWidth", this, 2.0, 0.1, 4.0, 2);
   public final DoubleValue lineTime = new DoubleValue(5091, "LineTime", this, 3000.0, 500.0, 20000.0, 0);
   public final BooleanValue killAura = new BooleanValue(6303, "AuraLine", this, true);
   public final ColorSetting killAuraColor = new ColorSetting(15897, "AuraColor", this, new Color(77, 0, 255, 255));
   public final DoubleValue killAuraLineWidth = new DoubleValue(5587, "AuraLineWidth", this, 2.0, 0.1, 4.0, 2);
   public final DoubleValue killAuraLineTime = new DoubleValue(6180, "AuraLineTime", this, 3000.0, 500.0, 20000.0, 0);

...
public class Teleport extends Module {
   ...
   public StringValue mode = new StringValue(15856, "Mode", this, "Vulcan", new String[]{"DEV", "Karhu", "Vulcan", "Vanilla", "SpartanB453"});
   public BooleanValue autoDisable = new BooleanValue(9374, "AutoDisable", this, true);

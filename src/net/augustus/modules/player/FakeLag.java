...
public class FakeLag extends Module {
   ...
   public DoubleValue startDelay = new DoubleValue(703, "StartDelay", this, 500.0, 0.0, 2000.0, 0);
   public DoubleValue lagDuration = new DoubleValue(8424, "LagPackets", this, 10.0, 1.0, 50.0, 0);
   public BooleanValue onlyMove = new BooleanValue(15778, "OnlyMove", this, false);
   public BooleanValue combat = new BooleanValue(9621, "Combat", this, false);
   ...
   public void onEventSendPacket(EventSendPacket eventSendPacket) {
      ...
      if (this.combat.getBoolean()) {
         if (packet instanceof C02PacketUseEntity) {
            this.shouldBlockPackets = false;
            this.resetPackets();
         } else if (packet instanceof C03PacketPlayer && mm.killAura.isToggled() && KillAura.target != null) {

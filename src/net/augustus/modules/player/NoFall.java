...
public class NoFall extends Module {
   ...
   public StringValue mode = new StringValue(15466, "Mode", this, "OnGround", new String[]{"OnGround", "NoGround", "Stop", "Legit", "ACR"});
   public DoubleValue fallDistance = new DoubleValue(1577, "MinFallDist", this, 2.0, 1.0, 24.0, 0);
   public DoubleValue legitFallDistance = new DoubleValue(4175, "MinFallDist", this, 6.0, 2.0, 24.0, 1);
   public DoubleValue lookRange = new DoubleValue(445, "AimRange", this, 8.0, 5.0, 30.0, 0);
   public DoubleValue yawSpeed = new DoubleValue(8312, "YawSpeed", this, 180.0, 0.0, 180.0, 0);
   public DoubleValue pitchSpeed = new DoubleValue(2374, "PitchSpeed", this, 180.0, 0.0, 180.0, 0);
   public DoubleValue delay = new DoubleValue(2063, "Delay", this, 110.0, 0.0, 2000.0, 0);

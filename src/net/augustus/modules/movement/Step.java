...
public class Step extends Module {
   public final DoubleValue height = new DoubleValue(4955, "Height", this, 1.0, 1.0, 5.0, 2);
   public final DoubleValue delay = new DoubleValue(8057, "Delay", this, 400.0, 0.0, 1000.0, 0);
   public final DoubleValue timer = new DoubleValue(14100, "Timer", this, 0.3, 0.05, 1.0, 2);
   private final TimeHelper timeHelper = new TimeHelper();
   public StringValue mode = new StringValue(9527, "Modes", this, "Vanilla", new String[]{"Vanilla", "NCPPacket", "NCPMotion", "Lowhop"});

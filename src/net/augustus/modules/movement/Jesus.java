...
public class Jesus extends Module {
   ...
   public StringValue mode = new StringValue(2696, "Mode", this, "Solid", new String[]{"Solid", "Speed", "Jump"});
   public DoubleValue speed = new DoubleValue(7017, "Speed", this, 1.0, 0.0, 20.0, 2);
   public DoubleValue motion = new DoubleValue(6879, "Motion", this, 0.6, 0.01, 2.0, 2);
   public BooleanValue onlyMove = new BooleanValue(7082, "OnlyMove", this, false);

...
public class Spider extends Module {
   public StringValue mode = new StringValue(15624, "Mode", this, "Jump", new String[]{"Basic", "Jump"});
   public final DoubleValue motionToJump = new DoubleValue(3994, "JumpMotion", this, -0.2, -0.42, 0.42, 2);
   public final BooleanValue customJumpMotion = new BooleanValue(6024, "CustomMotion", this, false);
   public final DoubleValue motion = new DoubleValue(3072, "Motion", this, 0.3, 0.0, 2.0, 2);
   public final BooleanValue onGroundPacket = new BooleanValue(9291, "GroundPacket", this, false);

...
public class Scaffold extends Module {
   public final DoubleValue yawSpeed = new DoubleValue(14582, "YawSpeed", this, 60.0, 0.0, 180.0, 0);
   public final DoubleValue pitchSpeed = new DoubleValue(12515, "PitchSpeed", this, 60.0, 0.0, 180.0, 0);
   public final DoubleValue expand = new DoubleValue(14623, "Expand", this, 0.0, 0.0, 3.0, 0);
   public final BooleanValue snap = new BooleanValue(3430, "Snap", this, false);
   public final BooleanValue resetRotation = new BooleanValue(4765, "ResetRotation", this, false);

   public final BooleanValue noDynamicFov = new BooleanValue(9013, "NoDynamicFov", this, false);
   //public final BooleanValue doGroundMotionMultiplier = new BooleanValue(301,"GroundMotionMulti",this,false);
   //  public DoubleValue doGroundMotionMutli_GroundMotionMultiplier = new DoubleValue(7216,"GroundMotion",this, 1.0, 0.0, 3, 4);

   //public final BooleanValue doAirMotionMultiplier = new BooleanValue(686,"AirMotionMulti",this,false);
   //public DoubleValue doAirMotionMulti_AirMotionMultiplier = new DoubleValue(16092,"AirMotion",this, 1.0, 0.0, 3.0, 4);
   public final BooleanValue rayCast = new BooleanValue(5613, "RayCast", this, false);
   public final BooleanValue playerYaw = new BooleanValue(5743, "PlayerYaw", this, false);
   public final BooleanValue blockSafe = new BooleanValue(1112, "BlockSafe", this, false);
   public final BooleanValue moonWalk = new BooleanValue(10659, "MoonWalk", this, false);
   public final BooleanValue godBridge = new BooleanValue(16193, "GodBridge", this, false);
   public final BooleanValue latestRotate = new BooleanValue(9711, "LatestRotate", this, false);
   public final BooleanValue latestPlace = new BooleanValue(14139, "LatestPlace", this, false);
   public final BooleanValue predict = new BooleanValue(8995, "Predict", this, false);
   public final DoubleValue backupTicks = new DoubleValue(13709, "Backup", this, 1.0, 0.0, 3.0, 0);
   public final BooleanValue adStrafe = new BooleanValue(1430, "AdStrafe", this, true);
   public final BooleanValue adStrafeLegit = new BooleanValue(129, "AdStrafeLegit", this, true);
   public final StringValue sprintMode = new StringValue(7975, "Sprint", this, "OffGroundSpeed",new String[]{"None","Legit","OffGroundSpeed","Always","Intave"});
   public final DoubleValue offGroundSpeed = new DoubleValue(190112,"OffGroundSpeed",this,0.20,0.05,0.30,2);
   public final DoubleValue ticksTodo = new DoubleValue(190113,"TicksToDo",this,0,0,50,0);
   public final BooleanValue moveFix = new BooleanValue(11957, "MoveFix", this, false);
   public final BooleanValue flyTest = new BooleanValue(14814, "FlyTest", this, false);
   public final BooleanValue spamClick = new BooleanValue(4129, "SpamClick", this, false);
   public final DoubleValue spamClickDelay = new DoubleValue(9799, "ClickDelay", this, 0.0, 0.0, 200.0, 0);
   public final BooleanValue intaveHit = new BooleanValue(14232, "IntaveHit", this, false);
   public final BooleanValue rotateToBlock = new BooleanValue(5745, "Rotate", this, true);
   public final BooleanValue correctSide = new BooleanValue(13681, "CorrectSide", this, true);
   public final BooleanValue sameY = new BooleanValue(10823, "SameY", this, false);
   public final BooleanValue autoJump = new BooleanValue(7436, "AutoJump", this, false);
   public final BooleanValue esp = new BooleanValue(5279, "ESP", this, true);
   public final StringValue towerMode = new StringValue(9741, "TowerMode", this, "None", new String[] {"None", "Vanilla", "LowHop", "FastJump", "NCP", "AAC"});
   public final BooleanValue towerMove = new BooleanValue(11478, "TowerMove", this, false);
   public final BooleanValue noSwing = new BooleanValue(12520, "NoSwing", this, false);
   public final BooleanValue noC0A = new BooleanValue(123520, "NoC0A", this, false);
   public final BooleanValue safewalk = new BooleanValue(2481, "SafeWalk", this, false);
   public final BooleanValue startSneak = new BooleanValue(16286, "StartSneak", this, false);
   public final BooleanValue sneak = new BooleanValue(13813, "Sneak", this, false);
   public final BooleanValue sneakOnPlace = new BooleanValue(5254, "SneakOnPlace", this, false);
   public final DoubleValue sneakTicks = new DoubleValue(13912, "SneakTicks", this, 1.0, 1.0, 10.0, 0);
   public final DoubleValue sneakBlocks = new DoubleValue(3215, "SneakBlocksF", this, 1.0, 1.0, 15.0, 0);
   public final DoubleValue sneakBlocksDiagonal = new DoubleValue(8623, "SneakBlocksD", this, 1.0, 1.0, 15.0, 0);
   public final BooleanValue sneakDelayBool = new BooleanValue(8350, "SneakDelay", this, false);
   public final DoubleValue sneakDelay = new DoubleValue(2212, "SneakDelay", this, 1000.0, 0.0, 4000.0, 0);
   public final DoubleValue timerSpeed = new DoubleValue(10682, "Timer", this, 1.0, 0.1, 4.0, 2);
   private final BooleanValue debug = new BooleanValue(9613, "Debug", this, false);
   ...
   public StringValue silentMode = new StringValue(11592, "SilentMode", this, "Spoof", new String[]{"Switch", "Spoof", "None"});
   public BooleanValue onWorld = new BooleanValue(9864, "DisableOnWorld", this, false);
   ...
   public void onEventSendPacket(EventSendPacket eventSendPacket) {
      if (eventSendPacket.getPacket() instanceof C0APacketAnimation) {
         eventSendPacket.setCancelled(this.noC0A.getBoolean());
      }
   }
   @EventTarget
   ...
   public void onEventEarlyTick(EventEarlyTick eventEarlyTick) {
      ...
      if (this.shouldScaffold()) {
         ...
         String var9 = this.sprintMode.getSelected();
         switch (var9){
            case "None":{
            ...
            case "OffGroundSpeed":{
               if (mc.thePlayer.ticksExisted % 3 == 0 && MoveUtil.isMoving() && MoveUtil.getSpeed2() < 0.23f
            ...
            case "Intave":{
               ...
               if (d) {
                  onoroff++;
                  if (!mc.thePlayer.onGround) {
                     if (mc.thePlayer.ticksExisted % 3 == 0 && MoveUtil.isMoving() && MoveUtil.getSpeed2() < 0.25f && !mc.gameSettings.keyBindJump.pressed && mc.thePlayer.hurtTime == 0) {
                        if (moveFix.getBoolean()) {
                           MoveUtil.strafe(-offGroundSpeed.getValue());
                        } else {
                           MoveUtil.strafe(offGroundSpeed.getValue());
                  ...
                  if (mc.thePlayer.onGround) {
                     ...
                     if (mc.thePlayer.ticksExisted % 3 == 0 && MoveUtil.isMoving() && !mc.gameSettings.keyBindJump.pressed && mc.thePlayer.hurtTime == 0) {
                        if (moveFix.getBoolean()) {
                           MoveUtil.strafe(0.01);
                        } else {
                           MoveUtil.strafe(-0.01);
                        }
                     }
         ...
         if (!this.rayCast.getBoolean()) {
            ...
            if (objectPosition != null) {
               ...
               switch(objectPosition.typeOfHit) {
                  case ENTITY:
                     if (mc.playerController.func_178894_a(mc.thePlayer, MovingObjectPosition.entityHit, objectPosition)) {
                        flag = false;
                     } else if (mc.playerController.interactWithEntitySendPacket(mc.thePlayer, MovingObjectPosition.entityHit)) {
                        flag = false;
                     }
                     break;
                  case BLOCK:
                        ...
                        if (objectPosition.sideHit == EnumFacing.UP) {
                           if (!this.sameY.getBoolean() || mc.gameSettings.keyBindJump.isKeyDown() && Mouse.isButtonDown(1)) {
                              ...
                              if (mc.playerController
                                 ...
                                 mc.thePlayer.swingItem();
                                 if (debug.getBoolean()) {
                                    System.out.println("[Scaffold][Debug] Placed.");
                                 }
                                 this.sneakCounter = 0;
                                 ++this.blockCounter;
                                 flag = false;
   ...
   public void onEventSaveWalk(EventSafeWalk eventSafeWalk) {
      if (this.sneak.getBoolean() && this.sneakOnPlace.getBoolean()) {
         eventSafeWalk.setDisableSneak(true);
      }
   }

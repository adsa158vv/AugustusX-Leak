...
public class Fucker extends Module {
   ...
   public StringValue block = new StringValue(1233, "Block", this, "Bed", new String[]{"Bed", "Cake", "Custom"});
   public StringValue action = new StringValue(9454, "Action", this, "Break", new String[]{"Break", "Click", "Use"});
   public BooleanValue troughWall = new BooleanValue(3136, "ThroughWall", this, true);
   public BooleanValue instant = new BooleanValue(12812, "Instant", this, true);
   public BooleanValue moveFix = new BooleanValue(5630, "MoveFix", this, true);
   public BooleanValue myBed = new BooleanValue(14092, "FriendMyBlock", this, true);
   public DoubleValue customID = new DoubleValue(13487, "CustomID", this, 26.0, 0.0, 400.0, 0);
   public DoubleValue yawSpeed = new DoubleValue(4217, "YawSpeed", this, 180.0, 0.0, 180.0, 0);
   public DoubleValue pitchSpeed = new DoubleValue(2034, "PitchSpeed", this, 180.0, 0.0, 180.0, 0);
   public DoubleValue delay = new DoubleValue(9367, "Delay", this, 500.0, 0.0, 1000.0, 0);
   public DoubleValue range = new DoubleValue(1850, "Range", this, 4.5, 0.0, 6.0, 1);
   ...
   private final INetHandler netHandler = null;
   ...
   public void onEventEarlyTick(EventEarlyTick eventEarlyTick) {
      this.setSuffix(this.block.getSelected(),true);
      Vec3 bedVec = null;
      if ((!mm.killAura.isToggled() || KillAura.target == null) && !BlockUtil.isScaffoldToggled()) {

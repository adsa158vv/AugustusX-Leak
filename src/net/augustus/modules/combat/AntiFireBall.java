...
public class AntiFireBall extends Module {
   ...
   public final BooleanValue rotate = new BooleanValue(13141, "Rotate", this, true);
   public final DoubleValue yawSpeed = new DoubleValue(10015, "YawSpeed", this, 60.0, 0.0, 180.0, 0);
   public final DoubleValue pitchSpeed = new DoubleValue(11614, "PitchSpeed", this, 60.0, 0.0, 180.0, 0);
   public final DoubleValue preRange = new DoubleValue(3219, "PreAimRange", this, 4.0, 0.0, 15.0, 1);
   public final DoubleValue delay = new DoubleValue(13446, "Delay", this, 60.0, 0.0, 400.0, 0);
   public final DoubleValue range = new DoubleValue(15912, "Range", this, 4.0, 0.0, 6.0, 2);
   public final BooleanValue moveFix = new BooleanValue(16373, "MoveFix", this, true);
   public final BooleanValue slowDown = new BooleanValue(11198, "SlowDown", this, true);
   public final DoubleValue ticksExisted = new DoubleValue(7959, "TicksExisted", this, 10.0, 0.0, 20.0, 0);
      ...
      if (this.shouldFireBall()
         ...
         if (this.slowDown.getBoolean()) {
            ...
            if (MovingObjectPosition.entityHit != null) {
               ...
               mc.thePlayer.sendQueue.addToSendQueue(new C02PacketUseEntity(MovingObjectPosition.entityHit, C02PacketUseEntity.Action.ATTACK));
            }
         }
   ...
   private boolean shouldFireBall() {
      return this.fireball != null && KillAura.target == null && !BlockUtil.isScaffoldToggled() && mc.currentScreen == null;
   }
   ...
   private void setRotation() {
      if (!BlockUtil.isScaffoldToggled() && KillAura.target == null) {

...
public class AutoClicker extends Module {
   public final DoubleValue minDelay = new DoubleValue(115, "MinDelay", this, 50.0, 0.0, 400.0, 0);
   public final DoubleValue maxDelay = new DoubleValue(492, "MaxDelay", this, 110.0, 0.0, 400.0, 0);
   public final BooleanValue smart = new BooleanValue(2096, "Smart", this, false);
   public final BooleanValue onlyOnTarget = new BooleanValue(9482, "OnlyOnTarget", this, false);

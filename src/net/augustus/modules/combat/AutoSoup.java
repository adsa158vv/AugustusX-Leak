...
public class AutoSoup extends Module {
   public DoubleValue health = new DoubleValue(6561, "Health", this, 13.0, 1.0, 20.0, 0);
   public BooleanValue drop = new BooleanValue(6099, "Drop", this, true);
   public BooleanValue fill = new BooleanValue(1752, "Fill", this, true);
   public BooleanValue autoOpen = new BooleanValue(755, "AutoOpen", this, true);
   public BooleanValue autoClose = new BooleanValue(4248, "AutoClose", this, true);

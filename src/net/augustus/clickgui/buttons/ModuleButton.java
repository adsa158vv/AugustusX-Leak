...
public class ModuleButton extends GuiButton implements MC {
   ...
   public void drawButton(Minecraft mc, int mouseX, int mouseY) {
      ...
      drawRect(this.xPosition, this.yPosition, this.xPosition +5, this.yPosition + this.height/2, ColorUtils.mixColors(new Color(78, 255, 166, 235),
              new Color(216, 255, 230, 235),ColorUtils.getBlendFactor(new Vector2d(this.xPosition,this.yPosition+ (double) this.height /2))).getRGB());
      drawRect(this.xPosition, this.yPosition+ this.height/2, this.xPosition +5, this.yPosition + this.height, ColorUtils.mixColors(new Color(78, 255, 166, 235),
              new Color(216, 255, 230, 235),ColorUtils.getBlendFactor(new Vector2d(this.xPosition,this.yPosition+ this.height))).getRGB());

...
public class CategoryButton extends GuiButton implements MC {
   ...
   public void drawButton(Minecraft mc, int mouseX, int mouseY) {
      ...
      RectUtils.drawRoundedRect((int)this.xPosition, (int)this.yPosition, (int)this.xPosition + this.width, (int)this.yPosition + this.height,3, new Color(22, 28, 31).getRGB());

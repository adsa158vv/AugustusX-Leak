...
public class ModuleTab extends Tab {
    ...
    static {
        try {
            arial18 = new UnicodeFontRenderer(Font.createFont(0, ModuleTab.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(18F));
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            arial16 = new UnicodeFontRenderer(Font.createFont(0, ModuleTab.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(16F));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

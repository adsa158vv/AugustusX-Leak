...
public class MainTab extends Tab {
    ...
    static {
        try {
            arial24 = new UnicodeFontRenderer(Font.createFont(0, MainTab.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(24F));
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            arial18 = new UnicodeFontRenderer(Font.createFont(0, MainTab.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(18F));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

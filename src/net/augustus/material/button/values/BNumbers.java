...
public class BNumbers extends Button {
    ...
    static {
        try {
            arial16B = new UnicodeFontRenderer(Font.createFont(0, BNumbers.class.getResourceAsStream("/resources/ArialB.ttf")).deriveFont(18F));
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            arial16 = new UnicodeFontRenderer(Font.createFont(0, BNumbers.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(16F));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

...
public final class Easings {
    ...
    public static final Easing CIRC_BOTH = value -> value < 0.5 ? (1.0 - Math.sqrt(1.0 - Math.pow(2.0 * value, 2.0))) / 2.0 : (Math.sqrt(1.0 - Math.pow(-2.0 * value + 2.0, 2.0)) + 1.0) / 2.0;
    ...
    public static final Easing BACK_BOTH = value -> value < 0.5 ? Math.pow(2.0 * value, 2.0) * (7.189819 * value - 2.5949095) / 2.0 : (Math.pow(2.0 * value - 2.0, 2.0) * (3.5949095 * (value * 2.0 - 2.0) + 2.5949095) + 2.0) / 2.0;
    ...
    public static Easing getEasingByName(String name) {
        ...
        if (name.equalsIgnoreCase("switchBack in")) {
            return BACK_IN;
        }
        if (name.equalsIgnoreCase("switchBack out")) {
            return BACK_OUT;
        }
        if (name.equalsIgnoreCase("switchBack both")) {
            return BACK_BOTH;
        }

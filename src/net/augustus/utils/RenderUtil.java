...
import static net.augustus.utils.skid.idek.Esp2DUtil.*;
...
public class RenderUtil implements MC {
   ...
   public static void otherDrawOutlinedBoundingBox(Entity entity, float x, float y, float z, double width, double height) {
      ...
      newYaw4 *= -1.0F;
      newYaw4 = (float)((double)newYaw4 * (Math.PI / 180.0));
      float x1 = (float)(Math.sin(newYaw1) * width + (double)x);
      float z1 = (float)(Math.cos(newYaw1) * width + (double)z);
      float x2 = (float)(Math.sin(newYaw2) * width + (double)x);
      float z2 = (float)(Math.cos(newYaw2) * width + (double)z);
      float x3 = (float)(Math.sin(newYaw3) * width + (double)x);
      float z3 = (float)(Math.cos(newYaw3) * width + (double)z);
      float x4 = (float)(Math.sin(newYaw4) * width + (double)x);
      float z4 = (float)(Math.cos(newYaw4) * width + (double)z);

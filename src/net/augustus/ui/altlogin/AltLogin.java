...
import net.augustus.ui.widgets.*;
...
public class AltLogin extends GuiScreen {
   ...
   private UUIDTextField uUIDTextField;
   private net.augustus.ui.widgets.TokenTextField tokenTextField;
   ...
   public void initGui() {
      ...
      this.uUIDTextField = new UUIDTextField(7, this.fontRendererObj, sr.getScaledWidth() / 2 - 100, 115, 200, 20);
      this.tokenTextField = new TokenTextField(8, this.fontRendererObj, sr.getScaledWidth() / 2 - 100, 145, 200, 20);
      this.emailTextField.setMaxStringLength(1337);
      this.passwordTextField.setMaxStringLength(1337);
      this.uUIDTextField.setMaxStringLength(1337);
      this.tokenTextField.setMaxStringLength(1337);
      this.buttonList.add(new CustomLoginButton(1, sr.getScaledWidth() / 2 - 100, 195, 200, 20, "Login", Augustus.getInstance().getClientColor()));
      this.buttonList.add(new CustomButton(2, sr.getScaledWidth() / 2 - 100, 225, 200, 20, "Last Alt", Augustus.getInstance().getClientColor()));
      this.buttonList.add(new CustomLoginButton(3, sr.getScaledWidth() / 2 - 100, 255, 200, 20, "Advanced Login", Augustus.getInstance().getClientColor()));
      this.buttonList.add(new CustomLoginButton(6, sr.getScaledWidth() / 2 - 100, 285, 200, 20, "Generate Cracked", Augustus.getInstance().getClientColor()));
      this.buttonList.add(new CustomLoginButton(420, sr.getScaledWidth() / 2 - 100, 315, 200, 20, "Browser Login", Augustus.getInstance().getClientColor()));
   ...
   protected void actionPerformed(GuiButton button) throws IOException {
      ...
      if (button.id == 3) {
         this.username = emailTextField.getText();
         this.password = "";
         this.uuid = uUIDTextField.getText();
         this.token = tokenTextField.getText();
         this.loginThread = new LoginThread(this.username, this.password, this.uuid,this.token,false, false);
      ...
      if (button.id == 5) {
         try {
            File dir = new File(this.mc.mcDataDir, "AugustusX");
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.uUIDTextField.drawTextBox();
      this.tokenTextField.drawTextBox();
      ScaledResolution sr = new ScaledResolution(this.mc);
      ...
      if (this.emailTextField.isFocused()) {
         ...
         this.uUIDTextField.setFocused(false);
         this.tokenTextField.setFocused(false);
      }
      ...
      if (this.uUIDTextField.isFocused()){
         this.passwordTextField.setFocused(false);
         this.tokenTextField.setFocused(false);
         this.emailTextField.setFocused(false);
      }
      if (this.tokenTextField.isFocused()){
         this.passwordTextField.setFocused(false);
         this.uUIDTextField.setFocused(false);
         this.emailTextField.setFocused(false);
      }
      ...
      if (this.emailTextField.getText().isEmpty() && !this.emailTextField.isFocused()) {
         this.fontRendererObj.drawStringWithShadow("E-Mail / Username", (float)scaledWidth / 2.0F - 96.0F, 61.0F, Color.gray.getRGB());
      }
      ...
      if (this.uUIDTextField.getText().isEmpty() && !this.uUIDTextField.isFocused()) {
         this.fontRendererObj.drawStringWithShadow("AdvancedUUID", (float)scaledWidth / 2.0F - 96.0F, 121.0F, Color.gray.getRGB());
      }
      if (this.tokenTextField.getText().isEmpty() && !this.tokenTextField.isFocused()) {
         this.fontRendererObj.drawStringWithShadow("AdvancedToken", (float)scaledWidth / 2.0F - 96.0F, 151.0F, Color.gray.getRGB());
      }
   }
   ...
   protected void keyTyped(char typedChar, int keyCode) throws IOException {
      ...
      this.uUIDTextField.textboxKeyTyped(typedChar, keyCode);
      this.tokenTextField.textboxKeyTyped(typedChar, keyCode);
   ...
   protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
      ...
      this.uUIDTextField.mouseClicked(mouseX, mouseY, mouseButton);
      this.tokenTextField.mouseClicked(mouseX, mouseY, mouseButton);
   ...
   public void updateScreen() {
      ...
      this.uUIDTextField.updateCursorCounter();
      this.tokenTextField.updateCursorCounter();
      super.updateScreen();
   }

...
public class LoginThread extends Thread implements MC {
   ...
   public LoginThread(String username, String password, String uuid, String token, boolean isGen, boolean isBrowser) {
      super("Login Thread");
   ...
   public void run() {
      ...
      if (this.password.equals("") && this.uuid.equals("") && this.token.equals("")) {
      ...
      if (this.password.equals("") && !this.uuid.equals("") && !this.token.equals("") && !this.username.equals("")) {
         mc.setSession(new Session(this.username, this.uuid, this.token, "microsoft"));
         this.status = "Logged in - (" + this.username + ") Advanced Login";
         this.loginSuccessSound();
         return;

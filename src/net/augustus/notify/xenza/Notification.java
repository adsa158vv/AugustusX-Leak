...
public class Notification {
    ...
    private final ResourceLocation check = ResourceUtil.loadResourceLocation("pictures/check.png", "check");
    private final ResourceLocation cross = ResourceUtil.loadResourceLocation("pictures/cross.png", "cross");

    static {
        try {
            arial16 = new UnicodeFontRenderer(Font.createFont(0, GuiIngameHook.class.getResourceAsStream("/resources/arial.ttf")).deriveFont(16F));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

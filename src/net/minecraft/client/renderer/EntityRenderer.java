...
public class EntityRenderer implements IResourceManagerReloadListener, MM {
   ...
   private static final ResourceLocation[] shaderResourceLocations = new ResourceLocation[]{
           new ResourceLocation("shaders/addNotification/notch.json"),
           new ResourceLocation("shaders/addNotification/fxaa.json"),
           new ResourceLocation("shaders/addNotification/art.json"),
           new ResourceLocation("shaders/addNotification/bumpy.json"),
           new ResourceLocation("shaders/addNotification/blobs2.json"),
           new ResourceLocation("shaders/addNotification/pencil.json"),
           new ResourceLocation("shaders/addNotification/color_convolve.json"),
           new ResourceLocation("shaders/addNotification/deconverge.json"),
           new ResourceLocation("shaders/addNotification/flip.json"),
           new ResourceLocation("shaders/addNotification/invert.json"),
           new ResourceLocation("shaders/addNotification/ntsc.json"),
           new ResourceLocation("shaders/addNotification/outline.json"),
           new ResourceLocation("shaders/addNotification/phosphor.json"),
           new ResourceLocation("shaders/addNotification/scan_pincushion.json"),
           new ResourceLocation("shaders/addNotification/sobel.json"),
           new ResourceLocation("shaders/addNotification/bits.json"),
           new ResourceLocation("shaders/addNotification/desaturate.json"),
           new ResourceLocation("shaders/addNotification/green.json"),
           new ResourceLocation("shaders/addNotification/blur.json"),
           new ResourceLocation("shaders/addNotification/wobble.json"),
           new ResourceLocation("shaders/addNotification/blobs.json"),
           new ResourceLocation("shaders/addNotification/antialias.json"),
           new ResourceLocation("shaders/addNotification/creeper.json"),
           new ResourceLocation("shaders/addNotification/spider.json")
   };
   ...
   public void loadEntityShader(Entity entityIn) {
      if (OpenGlHelper.shadersSupported) {
         ...
         if (entityIn instanceof EntityCreeper) {
            this.loadShader(new ResourceLocation("shaders/addNotification/creeper.json"));
         } else if (entityIn instanceof EntitySpider) {
            this.loadShader(new ResourceLocation("shaders/addNotification/spider.json"));
         } else if (entityIn instanceof EntityEnderman) {
            this.loadShader(new ResourceLocation("shaders/addNotification/invert.json"));
   ...
   public void getMouseOver(float partialTicks) {
      if (mm.killAura.isToggled() && mm.killAura.target != null) {
         ...
         if (entity != null && this.mc.theWorld != null) {
            final EventRayTraceRange eventRayTraceRange = new EventRayTraceRange((float) mm.killAura.range);
            EventHandler.call(eventRayTraceRange);
            this.mc.mcProfiler.startSection("pick");
            this.mc.pointedEntity = null;
            double d0 = (double)eventRayTraceRange.getBlockReachDistance();
            ...
            boolean flag = false;
            boolean flag1 = true;
            eventRayTraceRange.setRange((float) mm.killAura.range);
         ...
         if (entity != null && this.mc.theWorld != null) {
            @NotNull
            EventRayTraceRange eventRayTraceRange = new EventRayTraceRange(3.0f);
            EventHandler.call(eventRayTraceRange);
            this.mc.mcProfiler.startSection("pick");
            this.mc.pointedEntity = null;
            double d0 = (double)eventRayTraceRange.getBlockReachDistance();
            if (mm.teleport.isToggled()) {
               d0 = 200.0;
               eventRayTraceRange.setBlockReachDistance((float) d0);
            }
            ...
            if (this.mc.playerController.extendedReach()) {
               ...
               if (d0 > eventRayTraceRange.getRange()) {
                  flag = true;
               }
            ...
            if (this.pointedEntity != null && vec3.distanceTo(vec33) > 0.0) {
               eventRayTraceRange.setRayTraceRange((float)vec3.distanceTo(vec33));
            }
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > eventRayTraceRange.getRange()) {
               this.pointedEntity = null;
               this.mc.objectMouseOver = new MovingObjectPosition(MovingObjectPosition.MovingObjectType.MISS, vec33, (EnumFacing)null, new BlockPos(vec33));
            }
   ...
   private void hurtCameraEffect(float partialTicks) {
       if (!Augustus.getInstance().getModuleManager().hurtCam.modValue.getSelected().equals("Cancel") || !mm.hurtCam.isToggled()) {
   ...
   public boolean setFxaaShader(int p_setFxaaShader_1_) {
      if (!OpenGlHelper.isFramebufferEnabled()) {
         ...
         this.loadShader(new ResourceLocation("shaders/addNotification/fxaa_of_" + p_setFxaaShader_1_ + "x.json"));

...
public class PlayerControllerMP implements MM {
   ...
   public void syncCurrentPlayItem() {
      ...
      */
      ...
      if (mm.scaffold.isToggled() && mm.scaffold.silentMode.getSelected().equals("Spoof")) {
         i = mm.scaffold.getSlotID();
      }
   ...
   public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
      EventHandler.call(new EventAttackEntity(targetEntity, true));
      ...
      EventHandler.call(new EventAttackEntity(targetEntity, false));
   }

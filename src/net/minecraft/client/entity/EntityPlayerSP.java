...
import net.augustus.modules.ModuleHelper;
...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   private int counter;
   private final TimeHelper moveFixDelayTimeHelper = new TimeHelper();
   private final float forward = 0.0F;
   private final float strafe = 0.0F;
   ...
   public void onUpdate() {
      ...
      if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
         ...
         moduleHelper.SetVisible();
         moduleHelper.SetData();
         moduleHelper.SetKey();
         EventHandler.call(moduleHelper);
   ...
   public void onUpdateWalkingPlayer() {
      if (mm.postDis.isToggled() && PostDis.getGrimPost()) {
         ...
         EventMove eventMove = new EventMove(true);
         ...
         if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity == null) {
               ...
               if (mm.postDis.isToggled()) PostDis.processPackets();
            } else {
               this.sendQueue
                       .addToSendQueue(
                               new C03PacketPlayer.C06PacketPlayerPosLook(
         ...
         EventMove eventMove1 = new EventMove(false);
         EventHandler.call(eventMove1);
   ...
   public void swingItem() {
      ...
      super.swingItem();
      if (mm.viaPacketFix.isToggled() && mm.viaPacketFix.swing2.getBoolean()) {
         if (mm.viaPacketFix.debug.getBoolean()) mc.ingameGUI.getChatGUI().printChatMessage(new ChatComponentText("§F[§6ViaPacketFix§F][§5Debug§F]SwingItem() Function Triggered."));
         this.sendQueue.addToSendQueue(new CAnimateHandPacket(Hand.MAIN_HAND));
         if (mm.viaPacketFix.debug.getBoolean()) mc.ingameGUI.getChatGUI().printChatMessage(new ChatComponentText("§F[§6ViaPacketFix§F][§5Debug§F]CPacketAnimateHand Send."));
      } else {
   ...
   public void onLivingUpdate() {
      ...
      EventSlowDown eventSlowDown = new EventSlowDown(0.2F, 0.2F);
      EventHandler.call(eventSlowDown);
      ...
      if (this.onGround
              ...
              && !this.isSprinting()
              && flag3
              && (!this.isUsingItem() || eventSlowDown.isSprint())
      ...
      if (!eventSlowDown.isSprint() && this.isUsingItem() && !this.isRiding()) {
         this.setSprinting(false);
      }

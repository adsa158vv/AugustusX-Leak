...
import net.augustus.events.EventSetSound;
      ...
      protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
         ...
         if (this.visible) {
            if (this.field_146155_p) {
               ...
               EventSetSound eventSetSound = new EventSetSound(this.field_146153_r,this.field_146156_o);
               EventHandler.call(eventSetSound);

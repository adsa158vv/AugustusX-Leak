...
public class GuiMemoryErrorScreen extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawString(
         this.fontRendererObj, "We've tried to free up enough memory to let you go switchBack to", this.width / 2 - 140, this.height / 4 - 60 + 60 + 63, 10526880
      );
      this.drawString(
         this.fontRendererObj,
         "the main menu and switchBack to playing, but this may not have worked.",
         this.width / 2 - 140,

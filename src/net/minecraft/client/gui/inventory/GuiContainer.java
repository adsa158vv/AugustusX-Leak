...
import net.augustus.modules.world.ChestStealer;
import net.augustus.utils.skid.robin.RenderUtil;
...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      ChestStealer stealer = mm.chestStealer;
      Minecraft mc = Minecraft.getMinecraft();
      GuiScreen guiScreen = mc.currentScreen;
      if (stealer.getState() && stealer.silentValue.getBoolean()) {
         if (guiScreen instanceof GuiChest) {
            GuiChest chest = (GuiChest)guiScreen;
            if ((stealer.silentValue.getBoolean() || chest.lowerChestInventory != null)) {
               mc.setIngameFocus();
               mc.currentScreen = guiScreen;
               RenderUtil.drawLoadingCircle(sr.getScaledWidth() / 2, (float)sr.getScaledHeight() / 2.0f + 25.0f);
               String tipString = "Stealing";
               FontUtil.arial18.drawString(tipString, (float)this.width / 2.0f - (float)FontUtil.arial18.getStringWidth(tipString) / 2.0f, (float)this.height / 2.0f + 40.0f, -1);
               return;
            }
         }
      }
      ...
      for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1) {
         ...
         if (!(mc.currentScreen instanceof GuiChest && mm.chestStealer.silentValue.getBoolean() && mm.chestStealer.isToggled())) {
            this.drawSlot(slot);
         }
   ...
   private void drawSilentBackground() {
      ...
      this.fontRendererObj.drawString(text, 377,244, -1);

...
public abstract class EntityLivingBase extends Entity implements MM {
   ...
   public EntityLivingBase func_94060_bK() {
      return this._combatTracker.func_94550_c() != null
   ...
   public void onLivingUpdate() {
      ...
      if (this.isJumping || (mm.scaffoldWalk.jumpTiming.getSelected().equals("Parkou") && mm.scaffoldWalk.isToggled() && (this.isSprinting() || !mm.scaffoldWalk.sprint.getBoolean()) && this.onGround && Minecraft.getMinecraft().theWorld.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(0.0, -0.5, 0.0).expand(-0.001, 0.0, -0.001)).isEmpty())) {
         if (this.isInWater()) {
            this.updateAITick();

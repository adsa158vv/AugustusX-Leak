...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      EventSafeWalk eventSafeWalk = new EventSafeWalk(x, y, z);
      if (this instanceof EntityPlayerSP) {
         EventHandler.call(eventSafeWalk);
         x = eventSafeWalk.getMotionX();
         y = eventSafeWalk.getMotionY();
         z = eventSafeWalk.getMotionZ();
      ...
      if (this.noClip) {
         ...
         if (this instanceof EntityPlayerSP && eventSafeWalk.isDisableSneak()) {
            sneak = false;
         }

         boolean flag = (this.onGround && sneak || eventSafeWalk.isSaveWalk()) && this instanceof EntityPlayer;
         if (flag) {
            double d6;
   ...
   public void moveFlying(float strafe, float forward, float friction) {
      EventMove eventMove = new EventMove(this.rotationYaw, friction,forward,strafe,true);
   ...
   public float getCollisionBorderSize() {
      return ViaMCP.getInstance().getVersion() > 47  ? 0.0F : 0.1F;
   }

...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void setisntUsingItem(boolean isntUsingItem){
      if (isntUsingItem) {
         this.itemInUse = null;
      }
   }
   ...
   public void onUpdate() {
      ...
      this.noClip = (mm.phase.isToggled() && mm.phase.mode.getSelected().equals("Vanilla")) || this.isSpectator();
      if (this.isSpectator()) {
         this.onGround = false;
      }
            ...
            if (flag2) {
               if (i > 0) {
                  ...
                  this.setSprinting(eventAttackSlowdown.isSprint());
                       ...
                       && Minecraft.getMinecraft().thePlayer.hurtTime > 0&&mc.thePlayer.hurtTime < mm.velocity.MaxAfterHurtTime.getValue()  && mc.thePlayer.isSwingInProgress  && MovingObjectPosition.entityHit !=null) {
   ...
   @Override
   public void jump() {
      if(!mm.scaffold.isTower2() || mm.scaffold.towerMode.getSelected().equals("None") || !mm.scaffold.isToggled()) {
         super.jump();

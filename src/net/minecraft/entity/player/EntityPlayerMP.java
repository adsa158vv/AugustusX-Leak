...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   public static EntityPlayerMP INSTANCE;
   ...
   public void onUpdate() {
      ...
      if (!this.worldObj.isRemote && !openContainer.canInteractWith(this)) {
         this.closeScreen();
         openContainer = this.inventoryContainer;
      }
   ...
   public void displayGui(IInteractionObject guiOwner) {
      ...
      openContainer = guiOwner.createContainer(this.inventory, this);
      openContainer.windowId = this.currentWindowId;
      openContainer.onCraftGuiOpened(this);
   }

   @Override
   public void displayGUIChest(IInventory chestInventory) {
      if (openContainer != this.inventoryContainer) {
         this.closeScreen();
      }
      ...
      if (chestInventory instanceof IInteractionObject) {
         ...
         openContainer = ((IInteractionObject)chestInventory).createContainer(this.inventory, this);
      } else {
         this.playerNetServerHandler
            .sendPacket(
         ...
         openContainer = new ContainerChest(this.inventory, chestInventory, this);
      }
   ...
   public void displayVillagerTradeGui(IMerchant villager) {
      this.getNextWindowId();
      openContainer = new ContainerMerchant(this.inventory, villager, this.worldObj);
      openContainer.windowId = this.currentWindowId;
      openContainer.onCraftGuiOpened(this);
   ...
   public void displayGUIHorse(EntityHorse horse, IInventory horseInventory) {
      ...
      openContainer = new ContainerHorseInventory(this.inventory, horseInventory, horse, this);
      openContainer.windowId = this.currentWindowId;
      openContainer.onCraftGuiOpened(this);
   }
   ...
   public void closeScreen() {
      this.playerNetServerHandler.sendPacket(new S2EPacketCloseWindow(openContainer.windowId));
      this.closeContainer();
   }
